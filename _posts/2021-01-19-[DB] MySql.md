...
### 16 primary key를 가지는 것을 원칙
없는 경우 sequece index로 pk를 줌

### 17 최근에는 id를 따로 안쓰고 email로 아이디 처리 함

### 18 외래키 조건
부모키는 유일한 값을 가지고 있어야 함.




<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwNzE1MzA3LC00NDI1MjQ5NDgsLTYxNz
c5NTc2NSwtNDAxODM1OTgwLDQwODIwNDU5OCwyMDA2NDEyOTMs
ODM5MjQ5NTksMTE3NjE3NDg4NF19
-->