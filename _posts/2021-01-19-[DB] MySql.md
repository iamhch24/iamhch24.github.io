...
```
insert member( 칼럼명 ...) valuse ( 값들...); // 필요한 것만 골라서, 갯수가 맞아야 함.
insert member valuses ( 값들...); // 이 경우는 정의된 필드 값을 모두 넣어줘야 함.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTk1ODE4NzgwLDgzNjk5ODI2LDI2NzAyNj
gzMiwxOTkyNzQ0MDEwLDIzNTA1MjE4NCwtMTg0NTczNzAxOSwy
MTA3MTUzMDcsLTQ0MjUyNDk0OCwtNjE3Nzk1NzY1LC00MDE4Mz
U5ODAsNDA4MjA0NTk4LDIwMDY0MTI5Myw4MzkyNDk1OSwxMTc2
MTc0ODg0XX0=
-->