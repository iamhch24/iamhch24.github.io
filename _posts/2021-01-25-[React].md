...
export  default  App;
```
각 path에서 index.js를 넣어주면 해당 path로 호출시 자동으로 index.js 명시 없이 실행됨
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODYwNzM4MzIxLC0xMjc4NTM5NzMzLDQyOT
A0ODIwMSwtNDc0MTQwNjM5LC0yNTc5MjE1MTYsMTEwMTQ0OTY5
MywtMTY0MjQzMTE4NSwtMTY2NzM0MzU2NiwxMzA2Nzg1Mjk2LC
0xOTYxNTk2Nzk4XX0=
-->